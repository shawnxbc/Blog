...
![image-20200524125958527](assets/1.png)

类似的，就表达式 `x y z` 而言，你既可以理解为 `(x y) z` ，也可以理解为 `x (y z)` ：

![image-20200524130208004](assets/2.png)
...
![image-20200526104116397](assets/3.png)
...
![image-20200526104900388](assets/4.png)
...
![image-20200527141432816](assets/5.png)
